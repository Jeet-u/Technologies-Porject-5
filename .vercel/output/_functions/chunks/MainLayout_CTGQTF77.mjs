import { c as createAstro, a as createComponent, r as renderTemplate, u as unescapeHTML, b as addAttribute, d as renderComponent, F as Fragment, m as maybeRenderHead, e as renderScript, s as spreadAttributes, j as renderSlot, k as renderHead } from './astro/server_C95AHqwB.mjs';
import 'kleur/colors';
import { c as getImage } from './_astro_assets_foqUXNTe.mjs';
...
const $$LanguagePicker = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(
    ...
    renderScript($$result, "/home/circuit/Technologies-Porject-5/src/components/ui/LanguagePicker.astro?astro&type=script&index=0&lang.ts")
  );
...
</p> </div> <!-- Social Brands --> <div> ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.facebook }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "facebookFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.x }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "xFooter" })}` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.github }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "githubFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.google }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "googleFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.slack }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "slackFooter" })} ` })} </div> </div> ${renderScript($$result, "/home/circuit/Technologies-Porject-5/src/components/sections/FooterSection.astro?astro&type=script&index=0&lang.ts")} </div> </footer>`;
