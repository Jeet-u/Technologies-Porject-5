/* empty css                                    */
import { c as createAstro, a as createComponent, r as renderTemplate, d as renderComponent, e as renderScript, m as maybeRenderHead } from '../../chunks/astro/server_C95AHqwB.mjs';
import 'kleur/colors';
import { S as SITE, a as $$MainLayout } from '../../chunks/MainLayout_CTGQTF77.mjs';
import { $ as $$Image } from '../../chunks/_astro_assets_foqUXNTe.mjs';
import { g as getCollection } from '../../chunks/_astro_content_BJr_vgCz.mjs';
/* empty css                                     */
...
Table of Contents:
</p> <div id="toc" class=""> <ul class="space-y-2 text-pretty text-base text-neutral-700 transition duration-300 dark:text-neutral-400"></ul> </div> </div> </div> <div class="md:pt-8"> <h1 class="mb-4 text-balance text-center text-2xl font-bold text-neutral-800 dark:text-neutral-200 sm:text-3xl md:mb-6 md:text-left"> ${post.data.title} </h1> <article class="text-pretty text-lg text-neutral-700 dark:text-neutral-300"> ${renderComponent($$result2, "Content", Content, {})} </article> </div> </div> </div> </section> ` })}  ${renderScript($$result, "/home/circuit/Technologies-Porject-5/src/pages/insights/[...slug].astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result, "/home/circuit/Technologies-Porject-5/src/pages/insights/[...slug].astro?astro&type=script&index=1&lang.ts")}`;
}, "/home/circuit/Technologies-Porject-5/src/pages/insights/[...slug].astro", undefined);

const $$file = "/home/circuit/Technologies-Porject-5/src/pages/insights/[...slug].astro";
